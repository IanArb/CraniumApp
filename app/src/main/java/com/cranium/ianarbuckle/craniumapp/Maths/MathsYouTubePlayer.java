 ...
 * Date 15/04/2015
 * Author: Cian Dunne
 * @Reference: https://developers.google.com/youtube/android/player/
 */
@TargetApi(Build.VERSION_CODES.GINGERBREAD)
public class MathsYouTubePlayer extends YouTubeFailureRecoveryActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maths_youtube_player);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer player,
        ...
        if (!wasRestored) {
            player.cuePlaylist("PL8426D13C9CC44856");
        }
    }
